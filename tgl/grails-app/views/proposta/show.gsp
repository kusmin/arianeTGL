...
<html>
    ...
    <body>
        ...
        <div id="show-proposta" class="content scaffold-show" role="main">
            ...
            <f:display bean="proposta" />
            <g:form resource="${this.proposta}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.proposta}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
